...
namespace EnumAnnotations
{
    ...
    public class EnumAnnotation
    {
        ...
        public static List<EnumAnnotation> GetDisplays<T>() where T : struct
        {
        ...
        /// <returns>A sorted list of EnumAnnotations for Enum Type of T </returns>
        public static List<EnumAnnotation> GetDisplays<T>(Func<EnumAnnotation, bool> predicate) where T : struct
        {
            return Enum.GetValues(typeof(T))
                .OfType<Enum>()
                .Select(v => new EnumAnnotation(v))
    ...
    /// </summary>
    public static class EnumAnnotationExtensions
    {
        /// <summary>
        ...
        public static string GetNameOrDefault(this Enum value, string defaultName)
        {
