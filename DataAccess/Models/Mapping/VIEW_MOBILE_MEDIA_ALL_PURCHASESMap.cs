...
{
    public class VIEW_MOBILE_MEDIA_ALL_PURCHASESMap : EntityTypeConfiguration<VIEW_MOBILE_MEDIA_ALL_PURCHASES>
    {
        public VIEW_MOBILE_MEDIA_ALL_PURCHASESMap()
        {
            // Primary Key
            this.HasKey(t => new { t.PurchaseID, t.MemberID, t.HorseName, t.Trainer, t.ClassID, t.HorseShowName, t.ProductID, t.HorseShowID, t.BackID, t.FileName, t.HasWMVAzure, t.ScheduleID });
            ...
            this.ToTable("VIEW_MOBILE_MEDIA_ALL_PURCHASES");
