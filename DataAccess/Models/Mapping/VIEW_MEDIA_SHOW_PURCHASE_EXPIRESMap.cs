...
{
    public class VIEW_MEDIA_SHOW_PURCHASE_EXPIRESMap : EntityTypeConfiguration<VIEW_MEDIA_SHOW_PURCHASE_EXPIRES>
    {
        public VIEW_MEDIA_SHOW_PURCHASE_EXPIRESMap()
        {
            // Primary Key
            ...
            this.ToTable("VIEW_MEDIA_SHOW_PURCHASE_EXPIRES");
