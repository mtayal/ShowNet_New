...
{
    public class VIEW_MEDIA_SHOW_PURCHASEMap : EntityTypeConfiguration<VIEW_MEDIA_SHOW_PURCHASE>
    {
        public VIEW_MEDIA_SHOW_PURCHASEMap()
        {
            // Primary Key
            ...
            this.ToTable("VIEW_MEDIA_SHOW_PURCHASE");
